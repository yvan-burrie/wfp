...
/* ==================================================
  Metaboxes options
================================================== */
function meloo_toolkit_mb_music() {
	...
	/* Box Filter */
	if ( has_filter( 'rascals_mb_music_box' ) ) {
		$meta_info = apply_filters( 'rascals_mb_music_box', $meta_info );
	}
	...
	$meta_options = array(
		...
		array(
			...
			array(
				...
				'std'     => '',
				'height'  => '40',
				'desc'    => esc_html__( 'Artists', 'meloo-toolkit' ),
			),
	...
	/* Options Filter */
	if ( has_filter( 'rascals_mb_music_opts' ) ) {
		$meta_options = apply_filters( 'rascals_mb_music_opts', $meta_options );
	}

	/* Add class instance */
	$rascals_mb_music = new RascalsBox( $meta_options, $meta_info );
	...
	/* Meta info */ 
	$meta_info = array(
		'title' => esc_html__( 'Music Options', 'meloo-toolkit'), 
		'id'    =>'rascals_mb_music_template', 
		'page'  => array(
			'page'
		), 
		'context'  => 'normal', 
	...
	/* Box Filter */
	if ( has_filter( 'rascals_mb_music_template_box' ) ) {
		$meta_info = apply_filters( 'rascals_mb_music_template_box', $meta_info );
	}
	...
	$meta_options = array(
		...
		array(
			...
			array(
				...
				'desc' => esc_html__( 'Choose the recent music layout. The settings from this panel applies to the bottom of the page, where the loop and sidebar is.', 'meloo-toolkit' )
			),
	...
	/* Options Filter */
	if ( has_filter( 'rascals_mb_music_template_opts' ) ) {
		$meta_options = apply_filters( 'rascals_mb_music_template_opts', $meta_options );
	}

	/* Add class instance */
	$rascals_mb_music_template = new RascalsBox( $meta_options, $meta_info );
	...
	/* Meta info */ 
	$meta_info = array(
		'title' => esc_html__( 'Tracks Options', 'meloo-toolkit'), 
		...
		array(
			...
			array( 
				...
				'display_fields' => array(
					...
					array(
						'title' => esc_html__( 'Artist', 'meloo-toolkit' ),
						'name' => 'artists',
						'std' => esc_html__( 'Artist', 'meloo-toolkit' ),
						'type' => 'text',
						'classes' => ''
					),
				...
				'buttons' => array(
					array(
						...
						'title' => esc_html__( 'Add music tracks from media libary', 'meloo-toolkit'),
						'color' => 'blue'
					),
					array(
