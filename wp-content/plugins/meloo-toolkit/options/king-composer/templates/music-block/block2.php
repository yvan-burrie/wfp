...
<?php
    ...
    if ( $count < $limit ) {
        echo '<div class="warning">' . __( 'Warning: The number of posts is too small to display this module. The minimum number is: ', 'meloo-toolkit' ) . $limit . '</div>';
        break;
    }
...
<?php if ( $i % 3 === 1 ) : ?>
       <div class="kc-pb-col kc-pb-col2">
            <div class="kc-pb-row">
                <?php 
                    $module_args['thumb_size'] = 'meloo-content-thumb';
