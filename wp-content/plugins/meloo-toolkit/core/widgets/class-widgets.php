...
if ( ! class_exists( 'RascalsWidgets' ) ) :
class RascalsWidgets {
	...
	public function widgetsScripts( $hook ) {
		...
		if ( 'widgets.php' === $hook ) {
	        ...
	        wp_enqueue_script( 'rascals-widgets-admin' , esc_url( RASCALS_TOOLKIT_URL ) . '/core/widgets/js/admin-widgets.js' , array( 'jquery' ) ,false, true );

	     	wp_enqueue_style( 'rascals-widgets-admin', esc_url( RASCALS_TOOLKIT_URL ) . '/core/widgets/css/admin-widgets.css', array() , false , 'all' );
	    }
