...
class RascalsBox {
	...
	public function __construct( $options, $box ) {
		...
		foreach ( $this->options as $option ) {
			...
			if ( ! method_exists( $this, $option['type'] ) ) {
				...
				if ( file_exists( $this->args['admin_path'] . '/core/metabox/metabox-fields/' . $option['type'] . '/' . $file  ) ) {

					require_once( $this->args['admin_path'] . '/core/metabox/metabox-fields/' . $option['type'] . '/' . $file );
    ...
    */
	private function enqueue() {
		...
		/* UI */
		wp_enqueue_style( 'rascalsbox-ui', $this->args[ 'admin_url' ] . '/core/metabox/assets/css/admin-jquery-ui'. esc_attr( $this->minified  ) .'.css' );

		/* Metabox stylesheet */
		wp_enqueue_style( 'rascalsbox', $this->args[ 'admin_url' ] . '/core/metabox/assets/css/admin-metabox'. esc_attr( $this->minified  ) .'.css' );

		/* Metabox fonts */
		wp_enqueue_style( 'font-awesome', $this->args[ 'admin_url' ] . '/core/metabox/assets/vendors/font-awesome/font-awesome'. esc_attr( $this->minified  ) .'.css' );

		/* Metabox javascripts */
		wp_enqueue_script( 'rascalsbox', $this->args[ 'admin_url' ] . '/core/metabox/assets/js/admin-metabox'. esc_attr( $this->minified  ) .'.js', array( 'jquery', 'jquery-ui-core', 'jquery-ui-dialog', 'jquery-ui-widget', 'jquery-ui-sortable', 'jquery-ui-droppable', 'jquery-ui-slider', 'jquery-ui-draggable', 'jquery-ui-datepicker'), false, true );
