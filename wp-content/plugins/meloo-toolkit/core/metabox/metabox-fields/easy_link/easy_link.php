	...
	class RascalsBox_easy_link extends RascalsBox {
        ...
        */
			...
			if ( isset( self::$_option['dependency']) && is_array( self::$_option['dependency'] ) ) {
				...
				echo '<div class="box-row-input">';
					...
					echo '<div class="box-tc box-tc-input">';
						...
						echo '<label class="easylink-label">' . esc_html( rascals_esc_( 'Open link in new window/tab: ' ) ) . '<input name="' . esc_attr( self::$_option['id'][1]['id'] ) . '" type="hidden" value="no" /><input name="' . esc_attr( self::$_option['id'][1]['id'] ) . '" id="' . esc_attr( self::$_option['id'][1]['id'] ) . '" type="checkbox" class="link-new-window" value="yes" ' . esc_attr( $checked ) . ' /></label>';
						echo '<div class="clear"></div>';
						echo '<button class="_button easy-link special-button">' . esc_html( rascals_esc_( 'Insert Link' ) ) . '</button>';
		...
		private function widget() {
			...
			echo '<span>' . esc_html( rascals_esc_( 'Search' ) ) . '</span>';
