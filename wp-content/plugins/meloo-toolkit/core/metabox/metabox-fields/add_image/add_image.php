				...
				echo '<div class="box-tc box-tc-input">';
					...
					if ( $source === 'all' ) {
						...
						echo '<select size="1" class="image-source-select" >';
							...
							echo "<option " . esc_attr( $media_libary ) . " value='media_libary'>" . esc_html( rascals_esc_( 'Media libary' ) ) . "</option>";
							echo "<option " . esc_attr( $external_link ) . " value='external_link'>" . esc_html( rascals_esc_( 'External link' ) ) . "</option>";
					...
					echo '<div class="image-holder ' . esc_html(  $holder_classes ) . '">';
						...
						if ( $image && strpos( $image,  'kingcomposer/assets/images/get_start.jpg' ) === false ) {
							echo '<img src="' . esc_html( $image ) . '" alt="' . esc_attr( rascals_esc_( 'Preview Image' ) ) . '">';
						} 
