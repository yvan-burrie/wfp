				...
				echo '<div class="box-row-input">';
					...
					echo '<div class="box-tc box-tc-input">';
						...
						// ---------------------------------------
							...
							echo '</div>';
							echo '<button class="_button special-button generate-iframe" style="' . esc_attr( $display_g ) . '"><i class="fa icon fa-magic"></i>' . esc_html( rascals_esc_( 'Generate Iframe' ) ) . '</button>';
							
							echo '<button class="_button special-button ui-button-delete delete-iframe" style="' . esc_attr( $display_d ) . '"><i class="fa icon fa-trash-o"></i>' . esc_html( rascals_esc_( 'Remove' ) ) . '</button>';
							echo '<p class="msg msg-error" style="display:none;">' . esc_html( rascals_esc_( 'Error: Content does not contain the iframe.' ) ) . '</p>';
			...
			<div class="box-row clearfix">
				<div class="box-row-input">
					<div class="box-tc box-tc-label">
						<label for="color">' . esc_html( rascals_esc_( 'Iframe Code' ) ) . '</label>
					</div>
					<div class="box-tc box-tc-input">
					<textarea id="iframe-content" name="iframe_content" style="min-height:100px"></textarea>
					<p class="help-box">' . esc_html( rascals_esc_( 'Paste Iframe code here.' ) ) . '</p>
					</div>
				</div>
			</div>';
