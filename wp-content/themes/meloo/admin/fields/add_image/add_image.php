				...
				echo '<div class="box-tc box-tc-input">';
					...
					if ( $source === 'all' ) {
						...
						echo '<select size="1" class="image-source-select" >';
							...
							echo "<option ". esc_attr( $media_libary ) . " value='media_libary'>" . esc_html__( 'Media libary', 'meloo' ) . "</option>";
							echo "<option " . esc_attr( $external_link ) . " value='external_link'>" . esc_html__( 'External link', 'meloo' ) . "</option>";
					...
					echo '<div class="image-holder ' . esc_attr(  $holder_classes ) . '">';
						...
						if ( $image && strpos( $image,  'kingcomposer/assets/images/get_start.jpg' ) === false ) {
							echo '<img src="' . esc_url( $image ) . '" alt="' . esc_attr__( 'Preview Image', 'meloo' ) . '">';
						} 
