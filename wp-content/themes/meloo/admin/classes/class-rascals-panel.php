	...
	class RascalsThemePanel {
        ...
        */
		function display() {
			...
			if ( function_exists( 'meloo_admin_page_header' ) ) {
	        ...
	        echo '</ul>';
	        echo '</div>';
			echo '<button class="_button" id="_save"><i class="icon fa-save"></i><span class="r-save-text">' . esc_html__( 'Save Settings', 'meloo' ) . '</span></button>';
			echo '</div>';
		...
		public function get_image( $option, $size = 'full', $default = null ) {
			...
			if ( intval( $img ) ) {
		    	$image_att = wp_get_attachment_image_src( $img, $size );
			...
			echo '<div class="box-row clearfix">
				<div class="box-row-input">
					<div class="box-tc box-tc-label">
						<label for="color">' . esc_html__( 'Export Data', 'meloo' ) . '</label>
					</div>
		...
		private function import( $value ) {	
			...
			echo '<div class="box-row clearfix">
					<div class="box-row-input">
						<div class="box-tc box-tc-label">
							<label for="color">' . esc_html__( 'Import Data', 'meloo' ) . '</label>
						</div>
						<div class="box-tc box-tc-input">
							...
							<div class="clear"></div>
							<button class="_button data-import"><i class="fa fa-upload icon"></i>' . esc_html__( 'Import data', 'meloo' ) . '</button>
							<p class="help-box">' . esc_html__( 'Click on "Import data" button and paste in the box above previously exported data, and press the save button.', 'meloo' ) . '</p>
						</div>
					</div>
					<div class="box-row-line"></div>
				</div>';
